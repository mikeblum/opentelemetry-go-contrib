module go.opentelemetry.io/contrib/internal/e2e/weaver

go 1.25.0

require (
	github.com/ory/dockertest/v3 v3.11.0
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.0.0
	go.opentelemetry.io/contrib/instrumentation/host v0.0.0
...
replace (
	...
	go.opentelemetry.io/contrib/instrumentation/host => ../../../instrumentation/host
